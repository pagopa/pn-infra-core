...
external_roles_config = {"SendExtAdmin":{"managed_policies":["AdministratorAccess"]},"SendExtReadOnly":{"managed_policies":["ReadOnlyAccess"],"inline_policies":[{"name":"kms-decrypt.json","file":"./policies/kms-decrypt.json"}]},"SendExtPowerUser":{"managed_policies":["ReadOnlyAccess","AmazonSSMFullAccess","SecretsManagerReadWrite","AWSCodeBuildDeveloperAccess","AmazonDynamoDBFullAccess","AWSLambda_FullAccess"],"inline_policies":[{"name":"kms-decrypt.json","file":"./policies/kms-decrypt.json"},{"name":"cfn-upload.json","file":"./policies/cfn-upload.json"}]}}
