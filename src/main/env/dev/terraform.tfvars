...
pn_cors_addictive_sources = "http://localhost:8090,https://develop.dsd2y68dbsoga.amplifyapp.com"
...
vpc_pn_core_internal_subnets_cidr = ["10.1.3.0/28","10.1.3.16/28","10.1.3.32/28","10.1.5.0/28","10.1.5.16/28","10.1.5.32/28","10.1.7.0/28","10.1.7.16/28","10.1.7.32/28","10.1.20.0/24","10.1.21.0/24","10.1.22.0/24","10.1.60.0/24","10.1.61.0/24","10.1.62.0/24","10.1.70.0/24","10.1.71.0/24","10.1.72.0/24","10.1.80.0/24","10.1.81.0/24","10.1.82.0/24"]
vpc_pn_core_internal_subnets_names = ["PN Core - API-GW VpcLink Subnet (dev) AZ 0","PN Core - API-GW VpcLink Subnet (dev) AZ 1","PN Core - API-GW VpcLink Subnet (dev) AZ 2","PN Core - RADD Ingress Subnet (dev) AZ 0","PN Core - RADD Ingress Subnet (dev) AZ 1","PN Core - RADD Ingress Subnet (dev) AZ 2","PN Core - Service Desk Ingress Subnet (dev) AZ 0","PN Core - Service Desk Ingress Subnet (dev) AZ 1","PN Core - Service Desk Ingress Subnet (dev) AZ 2","PN Core - PnCore Subnet (dev) AZ 0","PN Core - PnCore Subnet (dev) AZ 1","PN Core - PnCore Subnet (dev) AZ 2","PN Core - To Confidential Info Subnet (dev) AZ 0","PN Core - To Confidential Info Subnet (dev) AZ 1","PN Core - To Confidential Info Subnet (dev) AZ 2","PN Core - AWS Services Subnet (dev) AZ 0","PN Core - AWS Services Subnet (dev) AZ 1","PN Core - AWS Services Subnet (dev) AZ 2","PN Core - OpenSearch Subnet (dev) AZ 0","PN Core - OpenSearch Subnet (dev) AZ 1","PN Core - OpenSearch Subnet (dev) AZ 2"]
