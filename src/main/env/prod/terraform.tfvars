...
vpc_pn_core_internal_subnets_cidr = ["10.10.3.0/28","10.10.3.16/28","10.10.3.32/28","10.10.5.0/28","10.10.5.16/28","10.10.5.32/28","10.10.7.0/28","10.10.7.16/28","10.10.7.32/28","10.10.20.0/24","10.10.21.0/24","10.10.22.0/24","10.10.60.0/24","10.10.61.0/24","10.10.62.0/24","10.10.70.0/24","10.10.71.0/24","10.10.72.0/24","10.10.80.0/24","10.10.81.0/24","10.10.82.0/24"]
vpc_pn_core_internal_subnets_names = ["PN Core - API-GW VpcLink Subnet (prod) AZ 0","PN Core - API-GW VpcLink Subnet (prod) AZ 1","PN Core - API-GW VpcLink Subnet (prod) AZ 2","PN Core - RADD Ingress Subnet (prod) AZ 0","PN Core - RADD Ingress Subnet (prod) AZ 1","PN Core - RADD Ingress Subnet (prod) AZ 2","PN Core - Service Desk Ingress Subnet (prod) AZ 0","PN Core - Service Desk Ingress Subnet (prod) AZ 1","PN Core - Service Desk Ingress Subnet (prod) AZ 2","PN Core - PnCore Subnet (prod) AZ 0","PN Core - PnCore Subnet (prod) AZ 1","PN Core - PnCore Subnet (prod) AZ 2","PN Core - To Confidential Info Subnet (prod) AZ 0","PN Core - To Confidential Info Subnet (prod) AZ 1","PN Core - To Confidential Info Subnet (prod) AZ 2","PN Core - AWS Services Subnet (prod) AZ 0","PN Core - AWS Services Subnet (prod) AZ 1","PN Core - AWS Services Subnet (prod) AZ 2","PN Core - OpenSearch Subnet (prod) AZ 0","PN Core - OpenSearch Subnet (prod) AZ 1","PN Core - OpenSearch Subnet (prod) AZ 2"]
