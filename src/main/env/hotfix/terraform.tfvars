...
vpc_pn_core_internal_subnets_cidr = ["10.15.3.0/28","10.15.3.16/28","10.15.3.32/28","10.15.5.0/28","10.15.5.16/28","10.15.5.32/28","10.15.7.0/28","10.15.7.16/28","10.15.7.32/28","10.15.20.0/24","10.15.21.0/24","10.15.22.0/24","10.15.60.0/24","10.15.61.0/24","10.15.62.0/24","10.15.70.0/24","10.15.71.0/24","10.15.72.0/24","10.15.80.0/24","10.15.81.0/24","10.15.82.0/24"]
vpc_pn_core_internal_subnets_names = ["PN Core - API-GW VpcLink Subnet (hotfix) AZ 0","PN Core - API-GW VpcLink Subnet (hotfix) AZ 1","PN Core - API-GW VpcLink Subnet (hotfix) AZ 2","PN Core - RADD Ingress Subnet (hotfix) AZ 0","PN Core - RADD Ingress Subnet (hotfix) AZ 1","PN Core - RADD Ingress Subnet (hotfix) AZ 2","PN Core - Service Desk Ingress Subnet (hotfix) AZ 0","PN Core - Service Desk Ingress Subnet (hotfix) AZ 1","PN Core - Service Desk Ingress Subnet (hotfix) AZ 2","PN Core - PnCore Subnet (hotfix) AZ 0","PN Core - PnCore Subnet (hotfix) AZ 1","PN Core - PnCore Subnet (hotfix) AZ 2","PN Core - To Confidential Info Subnet (hotfix) AZ 0","PN Core - To Confidential Info Subnet (hotfix) AZ 1","PN Core - To Confidential Info Subnet (hotfix) AZ 2","PN Core - AWS Services Subnet (hotfix) AZ 0","PN Core - AWS Services Subnet (hotfix) AZ 1","PN Core - AWS Services Subnet (hotfix) AZ 2","PN Core - OpenSearch Subnet (hotfix) AZ 0","PN Core - OpenSearch Subnet (hotfix) AZ 1","PN Core - OpenSearch Subnet (hotfix) AZ 2"]
